...
app.use(express.static('public'));                       // Middleware para parsear datos en formato JSON
...
app.listen(port, '0.0.0.0', () => {     // Configuramos el servidor para escuchar en el puerto 5000 y aceptar conexiones desde cualquier IP (0.0.0.0)
     console.log('Server Running On http://localhost:5000');    // Asi con  esta configuración el puerto corre                                                                  // en cualquier navegador
});
